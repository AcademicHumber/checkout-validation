...
<div class="container-fluid ">
    <div class="row min-vh-100 align-items-center checkout">
        ...
        <div class="col-md-6 col-12 checkout-side" style="background-color:#FFFFFF;">
            <div class="d-flex justify-content-center">
            ...
            <div class="row text-center aling-item-center justify-content-center">
                <div class="col-sm-12">
                    <a href="<?php echo base_url('/thanks'); ?>" type="button" class="btn text-white p-2 fw-bold mt-3 rounded-pill" style="background-color: #39374D ; font-family:poppins ; margin:10px ; width : 200px">COMPRAR</a>
                </div>
            </div>
